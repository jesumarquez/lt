	...
	public class NativeJob : IJob
	{
		...
		*/
		...
		public virtual void Execute(JobExecutionContext context)
		{
			...
			var command = data.GetString(PropertyCommand);

			var parameters = data.GetString(PropertyParameters);
