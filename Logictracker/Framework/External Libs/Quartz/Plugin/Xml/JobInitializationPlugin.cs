...
namespace Quartz.Plugin.Xml
{
    ...
    public class JobInitializationPlugin : ISchedulerPlugin, IFileScanListener
    {
        ...
        /// </summary>
        public virtual bool OverwriteExistingJobs { get; set; }
        ...
        public virtual void Initialize(string pluginName, IScheduler sched)
        {
            ...
            var tokens = fileNames.Split(FileNameDelimiter);
     ...
     */
        ...
        private string BuildJobTriggerName(string fileBasename)
        {
            ...
            var jobTriggerName = JobInitializationPluginName + '_' + Name + '_' + fileBasename.Replace('.', '_');
        ...
        private void ProcessFile(JobFile jobFile)
        {
            ...
            var processor = new JobSchedulingDataProcessor(Validating, ValidatingSchema);
    ...
    internal class JobFile
    {
        ...
        public void Initialize()
        {
            ...
            try
            {
                ...
                var file = new FileInfo(fName); // files in filesystem
                if (!file.Exists)
                {
                    var url = plugin.classLoadHelper.GetResource(FileName);
                    if (url != null)
                    {
