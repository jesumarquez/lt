...
namespace Quartz.Simpl
{
	...
	public class PropertySettingJobFactory : SimpleJobFactory
	{
		...
		public virtual void SetObjectProperties(object obj, JobDataMap data)
		{
			...
			{
				var c = name.Substring(0, 1).ToUpper(CultureInfo.InvariantCulture);
				var propName = c + name.Substring(1);
				...
				try
				{
					...
					var goodValue = ObjectUtils.ConvertValueIfNecessary(paramType, o);
