...
namespace Quartz.Impl.Calendar
{
	...
	public class AnnualCalendar : BaseCalendar, ICalendar
	{
		...
		{
            var d = new DateTime(FixedYear, day.Month, day.Day);
		...
		public override DateTime GetNextIncludedTimeUtc(DateTime timeStampUtc)
		{
			...
			var baseTime = base.GetNextIncludedTimeUtc(timeStampUtc);
...
#else
            var day = TimeZoneInfo.ConvertTimeFromUtc(new DateTime(timeStampUtc.Year, timeStampUtc.Month, timeStampUtc.Day), TimeZoneInfo.Local);
#endif
	    ...
	    public bool Equals(AnnualCalendar obj)
	    {
	        if (obj == null)
	            return false;
             var toReturn = GetBaseCalendar() != null ? 
