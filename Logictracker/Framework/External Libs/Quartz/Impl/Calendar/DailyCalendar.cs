...
namespace Quartz.Impl.Calendar
{
    ...
    public class DailyCalendar : BaseCalendar
    {
        ...
        public override bool IsTimeIncluded(DateTime timeUtc)
        {
            ...
            var startOfDayInMillis = GetStartOfDay(timeUtc);
            var endOfDayInMillis = GetEndOfDay(timeUtc);
            var timeRangeStartingTimeInMillis =
                GetTimeRangeStartingTimeUtc(timeUtc);
            var timeRangeEndingTimeInMillis =
        ...
        {
            var nextIncludedTime = timeUtc.AddMilliseconds(oneMillis);
        ...
        {
            var rangeStartingTime = new DateTime(timeUtc.Year, timeUtc.Month, timeUtc.Day,
        ...
        {
            var rangeEndingTime = new DateTime(timeUtc.Year, timeUtc.Month, timeUtc.Day,
                                  ...
                                  string rangeEndingTimeString)
        {
            ...
            var rangeStartingHourOfDay = Convert.ToInt32(rangeStartingTime[0], CultureInfo.InvariantCulture);
            var rangeStartingMinute = Convert.ToInt32(rangeStartingTime[1], CultureInfo.InvariantCulture);
            ...
            var rangeEndingHourOfDay = Convert.ToInt32(rangeEndingTime[0], CultureInfo.InvariantCulture);
            var rangeEndingMinute = Convert.ToInt32(rangeEndingTime[1], CultureInfo.InvariantCulture);
        ...
        {
            var endOfDay = new DateTime(time.Year, time.Month, time.Day, 23, 59, 59, 999);
            return endOfDay;
        }
