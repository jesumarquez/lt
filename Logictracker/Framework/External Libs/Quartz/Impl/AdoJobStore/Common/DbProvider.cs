...
namespace Quartz.Impl.AdoJobStore.Common
{
    ...
    public class DbProvider : IDbProvider
    {
        ...
        {
            // parse metadata
            var pp = PropertiesParser.ReadFromEmbeddedAssemblyResource(DbProviderResourceName);
            var providers = pp.GetPropertyGroups(PropertyDbProvider);
        ...
        {
            var conn = (IDbConnection)ObjectUtils.InstantiateType(dbMetadata.ConnectionType);
