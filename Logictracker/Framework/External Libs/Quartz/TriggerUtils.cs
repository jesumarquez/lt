...
namespace Quartz
{
	...
	public sealed class TriggerUtils
	{
		...
		{
			var trig = MakeDailyTrigger(hour, minute);
			trig.Name = trigName;
			return trig;
		}
		...
		{
			var trig = MakeWeeklyTrigger(dayOfWeek, hour, minute);
			trig.Name = trigName;
			return trig;
		}
		...
		{
			var trig = MakeMonthlyTrigger(dayOfMonth, hour, minute);
			trig.Name = trigName;
			return trig;
		}
		...
		{
			var trig = MakeImmediateTrigger(repeatCount, repeatInterval);
			trig.Name = trigName;
			return trig;
		}
		...
		{
			var trig = MakeSecondlyTrigger(intervalInSeconds, repeatCount);
			trig.Name = trigName;
			return trig;
		}
		...
		{
			var trig = MakeMinutelyTrigger(intervalInMinutes, repeatCount);
			trig.Name = trigName;
			return trig;
		}
		...
		{
			var trig = MakeHourlyTrigger(intervalInHours, repeatCount);
			trig.Name = trigName;
			return trig;
		}
        ...
        public static DateTime GetEvenHourDate(NullableDateTime dateUtc)
		{
            ...
            var d = dateUtc.Value.AddHours(1);
