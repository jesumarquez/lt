...
{
    public abstract class CustomAuthenticationAttribute : Attribute, IAuthenticationFilter
    {
        ...
        public async Task AuthenticateAsync(HttpAuthenticationContext context, CancellationToken cancellationToken)
        {
            ...
            if (authorization == null)
            {
                ...
                context.ErrorResult = new AuthenticationFailureResult("Credentials required", request);
            ...
            if (usuario!=null)
            {
                principal = new GenericPrincipal(new GenericIdentity(userName),new[] {string.Empty});
