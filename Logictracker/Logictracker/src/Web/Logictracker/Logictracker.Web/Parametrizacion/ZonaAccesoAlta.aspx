<%@ Page Language="C#" MasterPageFile="~/MasterPages/AbmPage.master" AutoEventWireup="true" Inherits="Logictracker.Parametrizacion.ZonaAccesoAlta" Codebehind="ZonaAccesoAlta.aspx.cs" %>
            ...
            <tr>
                <td valign="top" width="50%">
                    <cwc:AbmTitledPanel ID="panelTop" runat="server" TitleVariableName="DATOS_GENERALES" TitleResourceName="Labels" Height="130px">
                        ...
                        <cwc:ResourceLabel ID="lblTipoZonaAcceso" runat="server" ResourceName="Entities" VariableName="PARENTI91" Width="100px" />
                        <asp:UpdatePanel ID="upTipoZonaAcceso" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                            <ContentTemplate>
                                <cwc:TipoZonaAccesoDropDownList ID="cbTipoZonaAcceso" AddAllItem="false" runat="server" Width="50%" ParentControls="cbEmpresa,cbLinea" />
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="cbEmpresa" EventName="SelectedIndexChanged" />
