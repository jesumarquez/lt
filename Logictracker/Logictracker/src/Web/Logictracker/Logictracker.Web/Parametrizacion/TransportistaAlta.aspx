            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <cwc:AbmTitledPanel ID="panelTopLeft" runat="server" TitleVariableName="DATOS_GENERALES" TitleResourceName="Labels" Height="240px">
                        ...
                        <asp:TextBox ID="txtTelefono" runat="server" Width="99%" MaxLength="20" />
    
                        <cwc:ResourceLabel ID="ResourceLabel2" runat="server" ResourceName="Labels" VariableName="MAIL" />
                        <asp:TextBox ID="txtMail" runat="server"  Width="99%" MaxLength="128" />
    
                        <cwc:ResourceLabel ID="ResourceLabel4" runat="server" ResourceName="Labels" VariableName="CONTACTO" />
                        <asp:TextBox ID="txtContacto" runat="server" Width="99%" MaxLength="128" />
                    ...
                    <cwc:AbmTitledPanel ID="AbmTitledPanel1" runat="server" TitleVariableName="TARIFAS" TitleResourceName="Labels" Height="240px">
                        <asp:UpdatePanel ID="updTarifas" runat="server" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                <table class="Grid">
                                    <tr>
                                        <th class="Grid_Header" style="width: 150px">
                                            <cwc:ResourceLabel ID="ResourceLabel6" runat="server" Font-Bold="true" ResourceName="Entities" VariableName="PARENTI18" />
                                        </th>
                                        <th class="Grid_Header" style="width: 75px">
                                            <cwc:ResourceLabel ID="ResourceLabel7" runat="server" Font-Bold="true" ResourceName="Labels" VariableName="TRAMO_CORTO" />
                                        </th>
                                        <th class="Grid_Header" style="width: 75px">
                                            <cwc:ResourceLabel ID="ResourceLabel8" runat="server" Font-Bold="true" ResourceName="Labels" VariableName="TRAMO_LARGO" />
                                        </th>
                                        <th class="Grid_Header" style="width: 75px">
                                            <cwc:ResourceLabel ID="ResourceLabel5" runat="server" Font-Bold="true" ResourceName="Labels" VariableName="COSTO_BULTO" />
                                        </th>
                                        <th class="Grid_Header" style="width: 75px">
                                            <cwc:ResourceLabel ID="ResourceLabel10" runat="server" Font-Bold="true" ResourceName="Labels" VariableName="COSTO_HORA" />
                                        </th>
                                        <th class="Grid_Header" style="width: 75px">
                                            <cwc:ResourceLabel ID="ResourceLabel11" runat="server" Font-Bold="true" ResourceName="Labels" VariableName="COSTO_KM" />
                                        </th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <cwc:ResourceLabel ID="ResourceLabel9" runat="server" Font-Bold="true" ResourceName="Labels" VariableName="TODOS" />
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" id="txtTarifaCorto" Width="90%" />
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" id="txtTarifaLargo" Width="90%" />
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" id="txtCostoBulto" Width="90%" />
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" id="txtCostoHora" Width="90%" />
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" id="txtCostoKm" Width="90%" />
                                        </td>
                                    </tr>   
                                        <asp:Repeater ID="RepeaterTarifas" runat="server" onitemdatabound="RepeaterTarifas_ItemDataBound" onitemcommand="RepeaterTarifas_ItemCommand">
                                            <ItemTemplate>        
                                                <tr>
                                                    <td>
                                                        <asp:DropDownList ID="cbCliente" runat="server" Width="100%" DataTextField="Descripcion" DataValueField="Id" />
                                                    </td>
                                                    <td>
                                                        <asp:TextBox runat="server" id="txtTarifaCorto" Width="90%" />
                                                    </td>
                                    ...
                                    <tr>
                                        <th colspan="6" class="Grid_Header">
                                            <cwc:ResourceLinkButton ID="btNuevaTarifa" runat="server" onclick="btNuevaTarifa_Click" ResourceName="Controls" VariableName="BUTTON_TARIFA_DIFERENCIAL" />
                                        </th>
                                    </tr>
                                </table>
                            </ContentTemplate>
