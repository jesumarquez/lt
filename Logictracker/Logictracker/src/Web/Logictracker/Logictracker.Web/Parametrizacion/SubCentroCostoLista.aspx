<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListPage.master" AutoEventWireup="true" Inherits="Logictracker.Parametrizacion.SubCentroCostoLista" Codebehind="SubCentroCostoLista.aspx.cs" %>
