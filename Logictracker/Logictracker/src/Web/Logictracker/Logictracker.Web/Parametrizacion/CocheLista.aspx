<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListPage.master" AutoEventWireup="true" Inherits="Logictracker.Parametrizacion.CocheLista" Title="Coches" Codebehind="CocheLista.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentFiltros" Runat="Server"> 
    <table>
        <tr>
            ...
            <td>
                <cwc:ResourceLabel ID="lblParenti04" runat="server" ResourceName="Entities" VariableName="PARENTI04" /><br />
                <cwc:DepartamentoDropDownList ID="cbDepartamento" runat="server" Width="175px" OnSelectedIndexChanged="FilterChangedHandler" ParentControls="cbEmpresa,cbLinea" AddAllItem="true" AddNoneItem="true" />
            </td>
            <td>
