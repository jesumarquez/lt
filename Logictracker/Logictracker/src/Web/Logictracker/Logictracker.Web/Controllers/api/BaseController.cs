...
namespace Logictracker.Web.Controllers.api
{
    public class BaseController : EntityController<Linea, LineaDAO, BaseModel, LineaMapper>
    {
        ...
        public IEnumerable<BaseModel> GetBases(int distritoId)
        {
            return EntityDao.GetLineasPermitidasPorUsuario(new[] { distritoId }).Select(e => Mapper.EntityToModel(e, new BaseModel()));
        }
