<%@ Page Language="C#" MasterPageFile="~/MasterPages/ReportGridPage.master" AutoEventWireup="true" Inherits="Logictracker.Reportes.Accidentologia.RankingVehiculos" Codebehind="RankingVehiculos.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Filtros" Runat="Server"> 
    <table width="100%">
        <tr valign="top">
            ...
            <td align="left">
                <cwc:ResourceLinkButton id="lblTipoVehiculo" runat="server" ListControlTargetID="lbTipoVehiculo" Font-Bold="true" ForeColor="Black" ResourceName="Entities" VariableName="PARENTI17" />
                <br />
                <asp:UpdatePanel ID="upTipo" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                    <ContentTemplate>
                        <cwc:TipoVehiculoListBox ID="lbTipoVehiculo" runat="server" AutoPostBack="false" ParentControls="ddlDistrito,ddlBase" Width="150px" SelectionMode="Multiple" AddNoneItem="true" />
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddlDistrito" EventName="SelectedIndexChanged" />
            ...
            <td align="left">
                ...
                <asp:UpdatePanel ID="updCentroCosto" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                    <ContentTemplate>
                        <cwc:CentroDeCostosListBox ID="lbCentroCosto" runat="server" AutoPostBack="false" ParentControls="ddlDistrito,ddlBase" Width="150px" SelectionMode="Multiple" AddNoneItem="true" />
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddlDistrito" EventName="SelectedIndexChanged" />  
                        <asp:AsyncPostBackTrigger ControlID="ddlBase" EventName="SelectedIndexChanged" />
