<%@ Page Language="C#" MasterPageFile="~/MasterPages/AbmPage.master" AutoEventWireup="true" Inherits="Logictracker.Mantenimiento.ProveedorAlta" Codebehind="ProveedorAlta.aspx.cs" %>
            ...
            <tr>
                <td style="vertical-align: top; width:50%;">
                    <cwc:AbmTitledPanel ID="panelTopLeft" runat="server" TitleVariableName="DATOS_GENERALES" TitleResourceName="Labels" Height="150px">
                        ...
                        <cwc:ResourceLabel ID="lblTipoProveedor" runat="server" ResourceName="Entities" VariableName="PARENTI86" Width="100px" />
                        <asp:UpdatePanel ID="upTipoProveedor" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                            <ContentTemplate>
                                <cwc:TipoProveedorDropDownList ID="cbTipoProveedor" AddNoneItem="true" runat="server" Width="100%" ParentControls="cbEmpresa,cbLinea" />
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="cbEmpresa" EventName="SelectedIndexChanged" />
