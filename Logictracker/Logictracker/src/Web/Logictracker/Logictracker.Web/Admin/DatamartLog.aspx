        ...
        <tr>                 
            <td style="text-align: right;">
                <asp:Panel ID="panelBuscar" runat="server">
                    Buscar <asp:TextBox ID="txtBuscar" runat="server" Width="200px" AutoPostBack="true" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="DetalleSuperior" runat="server"></asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="DetalleInferior" runat="server"></asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="DetalleSuperiorPrint" runat="server"></asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="DetalleInferiorPrint" runat="server"></asp:Content>
