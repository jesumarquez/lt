<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ReportGridPage.master" AutoEventWireup="true" CodeFile="ReporteOdometros.aspx.cs" Inherits="Logictracker.Reportes.Estadistica.ReportesOdometrosReporteOdometros" %>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:UpdatePanel ID="upTipo" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                    <ContentTemplate>
                        <cwc:TipoVehiculoListBox runat="server" SelectionMode="Multiple" ID="lbTipo" Width="150px" ParentControls="ddlPlanta" AutoPostBack="false" />
                    </ContentTemplate>
                    <Triggers>
            ...
            <td>
                ...
                <asp:UpdatePanel ID="upMovil" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                    <ContentTemplate>
                        <cwc:MovilListBox runat="server" SelectionMode="Multiple" ID="lbMovil" Width="150px" ParentControls="ddlPlanta, lbTipo" UseOptionGroup="true" OptionGroupProperty="Estado" AutoPostBack="false" />
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddlPlanta" EventName="SelectedIndexChanged" />
            ...
            <td>
                ...
                <asp:UpdatePanel ID="upOdometro" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                    <ContentTemplate>
                        <cwc:OdometroListBox SelectionMode="Multiple" runat="server" ID="lbOdometro" Width="150px" AddGeneral="true" ParentControls="ddlPlanta, lbTipo" AutoPostBack="false" />
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="ddlPlanta" EventName="SelectedIndexChanged" />
                        <asp:AsyncPostBackTrigger ControlID="lbTipo" EventName="SelectedIndexChanged" />
