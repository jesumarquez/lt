...
{
    public partial class TipoProveedorAlta : SecuredAbmPage<TipoProveedor>
    {
        protected override string RedirectUrl { get { return "TipoProveedorLista.aspx"; } }
        ...
        protected override void OnDelete() { DAOFactory.TipoProveedorDAO.Delete(EditObject); }
        ...
        protected override void OnSave()
        {
            ...
            DAOFactory.TipoProveedorDAO.SaveOrUpdate(EditObject);
        }
        ...
        protected override void ValidateSave()
        {
            ...
            if (!DAOFactory.TipoProveedorDAO.IsCodeUnique(cbEmpresa.Selected, cbLinea.Selected, EditObject.Id, code))
