        ...
        public IEnumerable<MobileEvent> GetMobilesEventsByDistritoBase(int distritoId, int baseId)
        {
            ...
            var q = NHibernate.SessionHelper.Current
                ...
                .Select(Projections.ProjectionList()
                    ...
                    .Add(Projections.Property(() => tCoche != null ? tCoche.Descripcion : "").As("MobileType"))
                    .Add(Projections.Property(() => chofer != null ? chofer.Entidad.Descripcion : "").As("Driver"))
                    ...
                    .Add(Projections.Property(() => coche.Chofer != null ? coche.Chofer.Entidad.Descripcion : "").As("Responsable"))
                    .Add(Projections.Property(() => log.TieneFoto).As("TieneFoto"))
                    .Add(Projections.Property(() => log.IdPuntoDeInteres).As("IdPuntoInteres"))
                    .Add(Projections.Property(() => log.Estado > 0).As("Atendido"))
