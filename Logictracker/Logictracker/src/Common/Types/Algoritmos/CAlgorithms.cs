...
namespace Logictracker.Types.Algoritmos
{
    /// <summary>
    ...
    {        
        ...
        /// </returns>
        public static int OrientationIndex(PointF p1, PointF p2, PointF q)
        {
        ...
        public static bool IsPointInRing(PointF p, PointF[] ring)
        {
            int i;
        ...
        /// 0 if q is collinear with p1-p2-
        /// </returns>
        public static int ComputeOrientation(PointF p1, PointF p2, PointF q)
        {
